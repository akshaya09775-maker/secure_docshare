...
class Share(db.Model):
    ...
    def is_within_business_hours(self, now: datetime = None) -> bool:
        """Links only open between BUSINESS_HOURS_START and BUSINESS_HOURS_END
        (server local time), any day, up until the link's expiry date."""
    ...
    def is_valid(self) -> bool:
        return (
            ...
            and self.is_within_business_hours()
        )
